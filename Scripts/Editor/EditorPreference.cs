...
namespace RoyTheunissen.CreateScriptDialog.Utilities
{
    ...
    /// </summary>
    internal abstract class EditorPreference
    {
#if !UNITY_EDITOR
    ...
    internal abstract class EditorPreferenceGeneric<ValueType>
        : EditorPreference
    {
    ...
    internal class EditorPreferenceBool : EditorPreferenceGeneric<bool>
    {
    ...
    internal class EditorPreferenceString : EditorPreferenceGeneric<string>
    {
    ...
    internal class EditorPreferenceInt : EditorPreferenceGeneric<int>
    {
    ...
    internal class EditorPreferenceFloat : EditorPreferenceGeneric<float>
    {
    ...
    internal class EditorPreferenceObject<T> : EditorPreferenceGeneric<T>
        where T : Object
    {
